...
Invoke-WebRequest -Uri 'http://localhost:3000/api/articles' -Headers $headers
```

#### **Get Articles with Pagination & Search**
```powershell
# Search articles
Invoke-WebRequest -Uri 'http://localhost:3000/api/articles?search=react&page=1&limit=5'

# Filter by author
Invoke-WebRequest -Uri 'http://localhost:3000/api/articles?author=johndoe'
```
...
Invoke-WebRequest -Uri 'http://localhost:3000/api/articles' -Method POST -Headers $headers -Body $body
```

#### **Get Single Article**
```powershell
# Replace {article-id} with actual article ID from previous response
Invoke-WebRequest -Uri 'http://localhost:3000/api/articles/{article-id}'
```

#### **Like an Article**
```powershell
$headers = @{'Authorization' = "Bearer $token"}
Invoke-WebRequest -Uri 'http://localhost:3000/api/articles/{article-id}/like' -Method POST -Headers $headers
```
...
Invoke-WebRequest -Uri 'http://localhost:3000/api/comments' -Method POST -Headers $headers -Body $body
```
...
```powershell
$headers = @{'Authorization' = "Bearer $token"}
Invoke-WebRequest -Uri 'http://localhost:3000/api/auth/profile' -Headers $headers
```
...
Invoke-WebRequest -Uri 'http://localhost:3000/api/auth/profile' -Method PUT -Headers $headers -Body $body
```
